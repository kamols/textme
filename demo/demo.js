demo = {
  ...
  initChartPageCharts: function() {
    ...
    gradientFill = ctx.createLinearGradient(0, 170, 0, 50);
    gradientFill.addColorStop(0, "rgba(128, 182, 244, 0)");
    gradientFill.addColorStop(1, hexToRGB('#587cff', 0.6));
  ...
  initDashboardPageCharts: function() {
    ...
    var gradientStroke = ctx.createLinearGradient(500, 30, 100, 0);
    gradientStroke.addColorStop(0, '#587cff');
    gradientStroke.addColorStop(1, chartColor);

    var gradientFill = ctx.createLinearGradient(0, 67, 174, 50);
    gradientFill.addColorStop(0, "rgba(0, 67, 174, 0)");
    gradientFill.addColorStop(1, "rgba(69, 54, 0, 0.24)");
